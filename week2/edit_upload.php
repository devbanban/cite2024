...
if(isset($_GET['id'])){
    $stmtDataEdit = $condb->prepare("SELECT * FROM tbl_upload WHERE id=:id");
     //bindparam STR // INT
        ...
        <div class="col-sm-7">
          ...
          <form action="" method="post" enctype="multipart/form-data" onsubmit="return ValidateTypeFile(this);">
            <div class="row mb-2">
              ...
              <div class="col-sm-7">
                ภาพเก่า <br> 
                <img src="upload/<?=$editData['img_file_name'];?>" width="200px">
                <br><br> 
                เลือกใหม่ <br>
                <input type="file" name="img_file_name" class="form-control" accept="image/*">
              </div>
            </div>
            <div class="row mb-2">
